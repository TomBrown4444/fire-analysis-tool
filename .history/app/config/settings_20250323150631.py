...
US_STATE_BBOXES = {
    'All States': '-125.0,24.0,-66.0,50.0',
    'Alabama': '-88.5,30.2,-84.9,35.0',
    'Alaska': '-179.0,51.0,-130.0,71.5',
    'Arizona': '-114.8,31.3,-109.0,37.0',
    'Arkansas': '-94.7,33.0,-89.6,36.5',
    'California': '-124.4,32.5,-114.1,42.0',
    'Colorado': '-109.1,37.0,-102.0,41.0',
    'Connecticut': '-73.7,41.0,-71.8,42.1',
    ...
    'Iowa': '-96.6,40.4,-91.0,43.5',
    'Kansas': '-102.1,37.0,-94.6,40.0',
    'Kentucky': '-89.6,36.5,-82.0,39.1',
    'Louisiana': '-94.1,29.0,-89.0,33.0',
    'Maine': '-71.1,43.1,-67.0,47.5',
    'Maryland': '-79.5,38.0,-75.0,39.7',
    'Massachusetts': '-73.5,41.2,-70.0,42.9',
    ...
    'New Jersey': '-75.6,39.0,-74.0,41.4',
    ...
    'Washington': '-124.8,45.5,-117.0,49.0',
