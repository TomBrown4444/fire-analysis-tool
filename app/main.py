...
def main():
    ...
    with main_cols[0]:
        ...
        with st.expander("Advanced Settings"):
            eps = st.slider("Clustering Distance (degrees)", 0.001, 0.1, DEFAULT_EPS, 0.001,
                          help="Distance threshold for clustering points together. Higher values create larger clusters.")
            min_samples = st.slider("Minimum Cluster Size", 1, 20, DEFAULT_MIN_SAMPLES, 1,
                                  help="Minimum number of points to form a cluster. Higher values ignore smaller clusters.")
